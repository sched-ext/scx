...
It's also recommended that you include the following config options:
...
The [`scx/kernel.config`](./kernel.config) file includes all required and recommended options for using `sched_ext`.
