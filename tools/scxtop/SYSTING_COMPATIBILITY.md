...
scxtop now fully supports parsing and analyzing perfetto traces generated by [systing](https://github.com/hodgesd/systing), a system-wide tracing tool that uses perfetto's CompactSched format for efficient scheduler event encoding.
...
- ⚠️ TrackEvent format (partially supported - Phase 9)
...
- **Systing**: https://github.com/hodgesd/systing
