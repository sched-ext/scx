...
use crate::util::{format_kb, format_percentage};
...
macro_rules! memory_size_column {
    ($header:expr, $field:ident, $visible:expr) => {
        Column {
            ...
            visible: $visible,
            value_fn: Box::new(|_, data| format_kb(data.$field)),
        }
    };
}
    ...
    vec![
        ...
        detail_column!(
            ...
            |name, data| match name {
                "Total Memory" => format_kb(data.total_kb),
                "Free Memory" => format_kb(data.free_kb),
                "Available Memory" => format_kb(data.available_kb),
                "Buffers" => format_kb(data.buffers_kb),
                "Cached" => format_kb(data.cached_kb),
                "Active" => format_kb(data.active_kb),
                "Inactive" => format_kb(data.inactive_kb),
                "Active (anon)" => format_kb(data.active_anon_kb),
                "Inactive (anon)" => format_kb(data.inactive_anon_kb),
                "Active (file)" => format_kb(data.active_file_kb),
                "Inactive (file)" => format_kb(data.inactive_file_kb),
                "Unevictable" => format_kb(data.unevictable_kb),
                "Mlocked" => format_kb(data.mlocked_kb),
                "Dirty" => format_kb(data.dirty_kb),
                "Writeback" => format_kb(data.writeback_kb),
                "Anonymous Pages" => format_kb(data.anon_pages_kb),
                "Mapped" => format_kb(data.mapped_kb),
                "Slab" => format_kb(data.slab_kb),
                "SReclaimable" => format_kb(data.sreclaimable_kb),
                "SUnreclaim" => format_kb(data.sunreclaim_kb),
                "Kernel Stack" => format_kb(data.kernel_stack_kb),
                "Page Tables" => format_kb(data.page_tables_kb),
                "NFS Unstable" => format_kb(data.nfs_unstable_kb),
                "Bounce" => format_kb(data.bounce_kb),
                "Writeback Tmp" => format_kb(data.writeback_tmp_kb),
                "Commit Limit" => format_kb(data.commit_limit_kb),
                "Committed AS" => format_kb(data.committed_as_kb),
                "Swap Total" => format_kb(data.swap_total_kb),
                "Swap Free" => format_kb(data.swap_free_kb),
                "Swap Cached" => format_kb(data.swap_cached_kb),
