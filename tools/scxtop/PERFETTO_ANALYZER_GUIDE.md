...
The scxtop MCP server provides comprehensive perfetto trace analysis capabilities through a modular, extensible analyzer framework. This system enables deep analysis of Linux kernel tracing data from various sources including ftrace, Android systrace, and Chrome tracing.

**Key Features:**
- 17 built-in analyzers across 5 categories (Scheduling, Interrupt, I/O, Power, Extended)
...
- **v1.0** (2025) - Initial implementation with 17 analyzers, query framework, and auto-discovery
  - Phases 1-7 complete
  - 74+ tests passing
  - 23 MCP tools
