...
pub const ENUM_ABI_VALUES: &[(&str, &str, u64)] = &[
    ("scx_arena_consts", "SCX_ARENA_MIN_ORDER", 0x3),
    ("scx_arena_consts", "SCX_ARENA_GROW_PAGES", 0x4),
    ("scx_cap_flags", "__SCX_CAP_ENQ_IMMED", 0x0),
    ("scx_cap_flags", "__SCX_CAP_ENQ", 0x1),
    ("scx_cap_flags", "__SCX_CAP_PREEMPT", 0x2),
    ("scx_cap_flags", "__SCX_CAP_PERF", 0x3),
    ("scx_cap_flags", "__SCX_NR_CAPS", 0x4),
    ("scx_cap_flags", "__SCX_CAP_ALL", 0xf),
    ("scx_cap_flags", "SCX_CAP_ENQ_IMMED", 0x1),
    ("scx_cap_flags", "SCX_CAP_ENQ", 0x2),
    ("scx_cap_flags", "SCX_CAP_PREEMPT", 0x4),
    ("scx_cap_flags", "SCX_CAP_PERF", 0x8),
    ("scx_cap_flags", "SCX_CAP_BASE", 0x1),
    ("scx_cap_flags", "SCX_CAPS_REENQ_ON_LOSS", 0x3),
    ("scx_cid_consts", "SCX_CID_SHARD_SIZE_DFL", 0x18),
    ("scx_cid_consts", "SCX_CID_SHARD_MAX_CPUS", 0x200),
    ("scx_consts", "SCX_DSP_DFL_MAX_BATCH", 0x20),
    ("scx_consts", "SCX_DSP_MAX_LOOPS", 0x20),
    ("scx_consts", "SCX_WATCHDOG_MAX_TIMEOUT", 0x7530),
    ("scx_consts", "SCX_RESCUE_DFL_BW_PPT", 0x14),
    ("scx_consts", "SCX_RESCUE_MAX_BW_PPT", 0xfa),
    ("scx_consts", "SCX_RESCUE_DISABLE", 0xffffffff),
    ("scx_consts", "SCX_RESCUE_DFL_QUANTUM_US", 0x1388),
    ("scx_consts", "SCX_RESCUE_MIN_QUANTUM_US", 0x3e8),
    ("scx_consts", "SCX_RESCUE_MAX_QUANTUM_US", 0x186a0),
    ("scx_consts", "SCX_RESCUE_MIN_SLICE_US", 0x3e8),
    ("scx_consts", "SCX_RESCUE_OVERLOAD_MULT", 0x10),
    ("scx_consts", "SCX_RESCUE_MIN_OVERLOAD_MS", 0x3e8),
    ("scx_consts", "SCX_RESCUE_MAX_OVERLOAD_MS", 0x3a98),
    ("scx_consts", "SCX_TID_CHUNK", 0x400),
    ...
    ("scx_consts", "SCX_REENQ_MAX_REPEAT", 0x100),
    ...
    ("scx_dsp_verdict", "SCX_DSP_NONE", 0x0),
    ("scx_dsp_verdict", "SCX_DSP_LOCAL", 0x1),
    ("scx_dsp_verdict", "SCX_DSP_PREV", 0x2),
    ("scx_dsp_verdict", "SCX_DSP_RETRY", 0x3),
    ...
    ("scx_dsq_id_flags", "SCX_DSQ_REJECT", 0x8000000000000004),
    ("scx_dsq_id_flags", "SCX_DSQ_RESCUE", 0x8000000000000005),
    ...
    ("scx_enq_flags", "SCX_ENQ_RESCUE", 0x400000000),
    ...
    ("scx_enq_flags", "SCX_ENQ_IGNORE_CAPS", 0x1000000000000000),
    ("scx_enq_flags", "SCX_ENQ_APPLY_SLICE", 0x2000000000000000),
    ("scx_enq_flags", "SCX_ENQ_SLICE_DFL", 0x4000000000000000),
    ...
    ("scx_ent_flags", "SCX_TASK_PROTECTED", 0x40),
    ("scx_ent_flags", "SCX_TASK_STATE_SHIFT", 0x8),
    ("scx_ent_flags", "SCX_TASK_STATE_BITS", 0x3),
    ("scx_ent_flags", "SCX_TASK_STATE_MASK", 0x700),
    ("scx_ent_flags", "SCX_TASK_NONE", 0x0),
    ("scx_ent_flags", "SCX_TASK_INIT_BEGIN", 0x100),
    ("scx_ent_flags", "SCX_TASK_INIT", 0x200),
    ("scx_ent_flags", "SCX_TASK_READY", 0x300),
    ("scx_ent_flags", "SCX_TASK_ENABLED", 0x400),
    ("scx_ent_flags", "SCX_TASK_DEAD", 0x500),
    ("scx_ent_flags", "SCX_TASK_REENQ_REASON_SHIFT", 0xc),
    ("scx_ent_flags", "SCX_TASK_REENQ_REASON_BITS", 0x3),
    ("scx_ent_flags", "SCX_TASK_REENQ_REASON_MASK", 0x7000),
    ...
    ("scx_ent_flags", "SCX_TASK_REENQ_CAP", 0x4000),
    ...
    ("scx_exit_kind", "SCX_EXIT_PARENT_KILL", 0x45),
    ("scx_exit_kind", "SCX_EXIT_ERROR", 0x400),
    ("scx_exit_kind", "SCX_EXIT_ERROR_BPF", 0x401),
    ("scx_exit_kind", "SCX_EXIT_ERROR_STALL", 0x402),
    ("scx_exit_kind", "SCX_EXIT_ERROR_REENQ", 0x403),
    ("scx_exit_kind", "SCX_EXIT_ERROR_RESCUE", 0x404),
    ("scx_kf_allow_flags", "SCX_KF_ALLOW_UNLOCKED", 0x1),
    ("scx_kf_allow_flags", "SCX_KF_ALLOW_INIT_CIDS", 0x2),
    ("scx_kf_allow_flags", "SCX_KF_ALLOW_CPU_RELEASE", 0x4),
    ("scx_kf_allow_flags", "SCX_KF_ALLOW_DISPATCH", 0x8),
    ("scx_kf_allow_flags", "SCX_KF_ALLOW_ENQUEUE", 0x10),
    ("scx_kf_allow_flags", "SCX_KF_ALLOW_SELECT_CPU", 0x20),
    ...
    ("scx_ops_flags", "SCX_OPS_TID_TO_TASK", 0x100),
    ("scx_ops_flags", "SCX_OPS_ALL_FLAGS", 0x1ff),
    ...
    ("scx_reenq_flags", "SCX_REENQ_CAP_REVOKE", 0x2),
    ...
    ("scx_rq_flags", "SCX_RQ_SUB_IDLE_RENOTIFY", 0x80),
    ("scx_rq_flags", "SCX_RQ_ROOT_IDLE_RENOTIFY", 0x100),
    ("scx_rq_flags", "SCX_RQ_IN_WAKEUP", 0x10000),
    ("scx_rq_flags", "SCX_RQ_IN_DISPATCH", 0x20000),
    ("scx_sched_pcpu_flags", "SCX_SCHED_PCPU_BYPASSING", 0x1),
    ("scx_slice_oob_consts", "SCX_SLICE_OOB_DUR_BITS", 0x2b),
    ("scx_slice_oob_consts", "SCX_SLICE_OOB_ID_BITS", 0x14),
    ("scx_slice_oob_consts", "SCX_SLICE_OOB_DUR_MASK", 0x7ffffffffff),
    ("scx_slice_oob_consts", "SCX_SLICE_OOB_ID_SHIFT", 0x2b),
    ("scx_slice_oob_consts", "SCX_SLICE_OOB_ID_MASK", 0xfffff),
    ("scx_slice_oob_consts", "SCX_SLICE_OOB_PENDING", 0x8000000000000000),
    ("scx_tg_flags", "SCX_TG_ONLINE", 0x1),
    ("scx_tg_flags", "SCX_TG_INITED", 0x2),
    ("scx_tg_flags", "SCX_TG_SUB_INIT", 0x4),
