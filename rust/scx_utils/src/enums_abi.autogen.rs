...
pub const ENUM_ABI_VALUES: &[(&str, &str, u64)] = &[
    ...
    ("scx_kf_allow_flags", "SCX_KF_ALLOW_CPU_RELEASE", 0x2),
    ("scx_kf_allow_flags", "SCX_KF_ALLOW_DISPATCH", 0x4),
    ("scx_kf_allow_flags", "SCX_KF_ALLOW_ENQUEUE", 0x8),
    ("scx_kf_allow_flags", "SCX_KF_ALLOW_SELECT_CPU", 0x10),
