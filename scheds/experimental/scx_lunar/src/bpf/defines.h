...
#define STARVE_OVERRIDE_COOLDOWN_NS (40ULL * NS_PER_MS)
#define MIN_RUN_BEFORE_PREEMPT (200 * NS_PER_US)

#define SLICE_LC (1000 * NS_PER_US)
#define SLICE_INTERACTIVE (1000 * NS_PER_US)
#define SLICE_NORMAL (1000 * NS_PER_US)
#define SLICE_GREEDY (1000 * NS_PER_US)
