...
struct cpu_ctx {
	...
	u16		raw_cpu;	/* Linux CPU ID for per-CPU kernel data */
...
struct pick_ctx {
	 ...
	 */
	struct scx_cmask __arena *active; /* global active mask */
	struct scx_cmask __arena *ovrflw; /* global overflow mask */
	/*
