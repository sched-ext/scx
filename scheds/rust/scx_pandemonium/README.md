...
|--------------------------|-------------|----------|--------------|------------|-----------|
| EEVDF                    | **16.158s** | baseline | **3.66G**    | 26.58G     | **0.474** |
...
Cross-cache domain scatter:   nr_cross_domain path counters -> Rust MWU PATHWAY 6 (re-weights experts + affinity)
```
...
|------|---------|-------|---------|
| `slice_ns` | 1ms | MWU | Interactive slice ceiling |
