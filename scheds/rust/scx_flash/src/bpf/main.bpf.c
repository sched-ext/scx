...
static void update_task_deadline(struct task_struct *p, struct task_ctx *tctx)
{
	...
	/*
	 * Adjust the budget in function of the average CPU utilization:
	 * increase the allowed spread when CPUs are more utilized and
	 * reduce it when they are more idle.
	 */
