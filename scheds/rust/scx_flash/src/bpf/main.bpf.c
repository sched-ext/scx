...
{
	/*
	 * If @local_pcpu is enabled allow local dispatch only if there are
	 * no other tasks queued to the local DSQ. In this way we can
	 * prevent starving per-CPU tasks.
	 */
	if (!local_pcpu)
		return true;
