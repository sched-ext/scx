...
fn build_accelerator_summary(stats: &cake_stats, app: &TuiApp) -> AcceleratorSummary {
    let mut summary = AcceleratorSummary {
        ...
        frontier_pending_set: stats.frontier_pending_set,
        frontier_observe_count: stats.frontier_observe_count,
        frontier_observe_good: stats.frontier_observe_good,
        frontier_observe_bad: stats.frontier_observe_bad,
        frontier_conf_promote: stats.frontier_conf_promote,
        frontier_conf_decay: stats.frontier_conf_decay,
        frontier_conf_high: stats.frontier_conf_high,
        frontier_mode_counts: stats.frontier_mode_count,
        frontier_dispatch_trusted_attempts: stats.frontier_dispatch_trusted_attempt,
        frontier_dispatch_trusted_hits: stats.frontier_dispatch_trusted_hit,
        frontier_dispatch_trusted_fails: stats.frontier_dispatch_trusted_fail,
        frontier_dispatch_audit_skips: stats.frontier_dispatch_audit_skip,
        frontier_dispatch_audit_due: stats.frontier_dispatch_audit_due,
        frontier_select_prev_attempts: stats.frontier_select_prev_attempt,
        frontier_select_prev_hits: stats.frontier_select_prev_hit,
        frontier_select_prev_misses: stats.frontier_select_prev_miss,
        frontier_enqueue_fact_attempts: stats.frontier_enqueue_fact_attempt,
        frontier_enqueue_fact_hits: stats.frontier_enqueue_fact_hit,
        frontier_enqueue_fact_misses: stats.frontier_enqueue_fact_miss,
        frontier_token_clears: stats.frontier_token_clear,
