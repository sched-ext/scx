...
pub struct AcceleratorSummary {
    ...
    pub frontier_pending_set: u64,
    pub frontier_observe_count: u64,
    pub frontier_observe_good: u64,
    pub frontier_observe_bad: u64,
    pub frontier_conf_promote: u64,
    pub frontier_conf_decay: u64,
    pub frontier_conf_high: u64,
    pub frontier_mode_counts: [u64; 4],
    pub frontier_dispatch_trusted_attempts: u64,
    pub frontier_dispatch_trusted_hits: u64,
    pub frontier_dispatch_trusted_fails: u64,
    pub frontier_dispatch_audit_skips: u64,
    pub frontier_dispatch_audit_due: u64,
    pub frontier_select_prev_attempts: u64,
    pub frontier_select_prev_hits: u64,
    pub frontier_select_prev_misses: u64,
    pub frontier_enqueue_fact_attempts: u64,
    pub frontier_enqueue_fact_hits: u64,
    pub frontier_enqueue_fact_misses: u64,
    pub frontier_token_clears: u64,
}
