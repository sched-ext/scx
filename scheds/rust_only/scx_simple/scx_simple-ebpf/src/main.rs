...
#[inline(always)]
pub fn on_select_cpu(_ctx: &mut BpfCtx, p: *mut task_struct, prev_cpu: i32, _wake_flags: u64) -> i32 {
...
pub fn on_enqueue(ctx: &mut BpfCtx, p: *mut task_struct, enq_flags: u64) {
    ctx.dsq_insert(p, SHARED_DSQ, kfuncs::SLICE_DFL, enq_flags);
}

#[inline(always)]
pub fn on_dispatch(ctx: &mut BpfCtx, _cpu: i32, _prev: *mut task_struct) {
    ctx.dsq_move_to_local(SHARED_DSQ);
}

#[inline(always)]
pub fn on_running(_ctx: &mut BpfCtx, _p: *mut task_struct) {}

#[inline(always)]
pub fn on_stopping(_ctx: &mut BpfCtx, _p: *mut task_struct, _runnable: bool) {}

#[inline(always)]
pub fn on_enable(_ctx: &mut BpfCtx, _p: *mut task_struct) {}

#[inline(always)]
pub fn on_init(ctx: &mut BpfCtx) -> i32 {
    ctx.create_dsq(SHARED_DSQ, -1)
}
